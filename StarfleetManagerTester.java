...
public class StarfleetManagerTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(new Officer("Lee Adama", 28, 5, OfficerRank.Captain));
		System.out.println(new CrewWoman(28, 5, "Lee Adama"));
		System.out.println(new Cylon("Lee Adama", 28, 5, 12));
	}
